...
# Пути к файлам модели YOLOv3-tiny: веса, конфигурация и имена классов
weights_path = "yolov3-tiny.weights"  # Весы модели
config_path = "yolov3-tiny.cfg"  # Конфигурация модели
classes_path = "coco-tiny.names"  # Список имен классов для модели
